...
public class PlayerActivity extends AppCompatActivity
  ...
  private ImageButton shareScreenButton;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    if(getIntent().hasExtra("EXTRA_HEADERS")){
      dataSourceFactory = buildDataSourceFactory((HashMap<String, String>) getIntent().getSerializableExtra("EXTRA_HEADERS"));
    }else {
  ...
  private void initializePlayer() {
    if (player == null) {
      ...
      if(getIntent().hasExtra("PLAYER_USER_AGENT")) {
        da.setUserAgent(getIntent().getStringExtra("PLAYER_USER_AGENT"));
      }
